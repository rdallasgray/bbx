...
class Inflector
{
    ...
    */
    public static function singularize($word)
    {
        ...
        $uncountable = array('audio', 'committee', 'equipment', 'information', 'rice', 'money', 'species', 'series', 'fish', 'sheep', 'press', 'news', 'music');
    ...
    */
    ...
    {
        $uppercase = $uppercase == 'first' ? 'ucfirst' : 'utf8_ucwords';
    ...
    */
    ...
    {
        $uppercase = $uppercase == 'all' ? 'utf8_titlecase' : 'utf8_ucfirst';
